...
//        Seattle to New York (22)
        ...
        dr = new DualRoute(cityMap.get("Montreal"), cityMap.get("Boston"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Montreal"), cityMap.get("Boston"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Boston"), cityMap.get("New_York"), 2, GameColor.YELLOW, true);
        dr2 = new DualRoute(cityMap.get("Boston"), cityMap.get("New_York"), 2, GameColor.RED, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("New_York"), cityMap.get("Washington"), 2, GameColor.ORANGE, true);
        dr2 = new DualRoute(cityMap.get("New_York"), cityMap.get("Washington"), 2, GameColor.BLACK, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Washington"), cityMap.get("Raleigh"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Washington"), cityMap.get("Raleigh"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Los_Angeles"), cityMap.get("San_Francisco"), 3, GameColor.PURPLE, true);
        dr2 = new DualRoute(cityMap.get("Los_Angeles"), cityMap.get("San_Francisco"), 3, GameColor.YELLOW, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Portland"), cityMap.get("San_Francisco"), 5, GameColor.PURPLE, true);
        dr2 = new DualRoute(cityMap.get("Portland"), cityMap.get("San_Francisco"), 5, GameColor.GREEN, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Portland"), cityMap.get("Seattle"), 1, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Portland"), cityMap.get("Seattle"), 1, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Vancouver"), cityMap.get("Seattle"), 1, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Vancouver"), cityMap.get("Seattle"), 1, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Duluth"), cityMap.get("Omaha"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Duluth"), cityMap.get("Omaha"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("New_York"), cityMap.get("Pittsburgh"), 2, GameColor.GREEN, true);
        dr2 = new DualRoute(cityMap.get("New_York"), cityMap.get("Pittsburgh"), 2, GameColor.WHITE, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Pittsburgh"), cityMap.get("Chicago"), 3, GameColor.ORANGE, true);
        dr2 = new DualRoute(cityMap.get("Pittsburgh"), cityMap.get("Chicago"), 3, GameColor.BLACK, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        allRoutes.add(new Route(cityMap.get("Raleigh"), cityMap.get("Nashville"), 3, GameColor.BLACK));
        dr = new DualRoute(cityMap.get("Raleigh"), cityMap.get("Atlanta"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Raleigh"), cityMap.get("Atlanta"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Atlanta"), cityMap.get("New_Orleans"), 4, GameColor.ORANGE, true);
        dr2 = new DualRoute(cityMap.get("Atlanta"), cityMap.get("New_Orleans"), 4, GameColor.YELLOW, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Oklahoma_City"), cityMap.get("Dallas"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Oklahoma_City"), cityMap.get("Dallas"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Oklahoma_City"), cityMap.get("Kansas_City"), 2, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Oklahoma_City"), cityMap.get("Kansas_City"), 2, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Denver"), 4, GameColor.BLACK, true);
        dr2 = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Denver"), 4, GameColor.ORANGE, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Omaha"), 1, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Omaha"), 1, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        dr = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Saint_Louis"), 2, GameColor.BLUE, true);
        dr2 = new DualRoute(cityMap.get("Kansas_City"), cityMap.get("Saint_Louis"), 2, GameColor.PURPLE, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        allRoutes.add(new Route(cityMap.get("Chicago"), cityMap.get("Omaha"), 4, GameColor.BLUE));
        dr = new DualRoute(cityMap.get("Chicago"), cityMap.get("Saint_Louis"), 2, GameColor.GREEN, true);
        dr2 = new DualRoute(cityMap.get("Chicago"), cityMap.get("Saint_Louis"), 2, GameColor.WHITE, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Denver"), cityMap.get("Salt_Lake_City"), 3, GameColor.RED, true);
        dr2 = new DualRoute(cityMap.get("Denver"), cityMap.get("Salt_Lake_City"), 3, GameColor.YELLOW, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Salt_Lake_City"), cityMap.get("San_Francisco"), 5, GameColor.ORANGE, true);
        dr2 = new DualRoute(cityMap.get("Salt_Lake_City"), cityMap.get("San_Francisco"), 5, GameColor.WHITE, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
        ...
        dr = new DualRoute(cityMap.get("Houston"), cityMap.get("Dallas"), 1, GameColor.GREY, true);
        dr2 = new DualRoute(cityMap.get("Houston"), cityMap.get("Dallas"), 1, GameColor.GREY, false);
        dr2.setSibling(dr);
        dr.setSibling(dr2);
        allRoutes.add(dr);
        allRoutes.add(dr2);
