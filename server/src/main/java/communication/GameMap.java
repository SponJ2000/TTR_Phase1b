...
public class GameMap {
    ...
    public GameMap() {
        ...
        City El_Paso = new City("El Paso", 31, -106);
        City Houston = new City("Houston", 29, -95);
        City Helena = new City("Helena", 46, -112);
        City Kansas_City = new City("Kansas City", 39, -94);
        City Las_Vegas = new City("Las Vegas", 36, -115);
        City Little_Rock = new City("Little Rock", 34, -92);
        City Los_Angeles = new City("Los Angeles", 34, -118);
        City Miami = new City("Miami", 25, -80);
        City Montreal = new City("Montreal", 45, -73);
        City Nashville = new City("Nashville", 36, -86);
        City New_Orleans = new City("New Orleans", 29, -90);
        City New_York = new City("New York", 40, -73);
        City Omaha = new City("Omaha", 41, -95);
        City Oklahoma_City = new City("Oklahoma City", 35, -97);
        ...
        City Saint_Louis = new City("Saint Louis", 38, -90);
        City Salt_Lake_City = new City("Salt Lake City", 40, -111);
        City San_Francisco = new City("San Francisco", 37, -122);
        City Santa_Fe = new City("Santa Fe", 35, -105);
        City Sault_Ste_Marie = new City("Sault Ste. Marie", 46, -84);
